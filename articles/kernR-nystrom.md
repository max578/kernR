...
observations it takes 2.23 seconds against 0.21 for Nystrom and 0.2 for
...
curve on logarithmic axes gives a slope of 2.2 for the exact test
against 1.62 for Nystrom and 1.74 for Random Fourier Features: the exact
