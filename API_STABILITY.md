...
`kernR` follows a published two-phase policy. The phase boundary is the
1.0.0 release.
...
machinery that downstream consumers (the PESTO ⇄ kernR ⇄ proxymix chain;
agricultural pipeline code; methods-paper supplementary material) wire
into long-lived calibration and verdict workflows. Silent breakage
...
pipeline, open an issue at <https://github.com/max578/kernR/issues> with
